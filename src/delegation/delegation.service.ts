...
export class DelegationService {
	...
	async updateDelegation(id: number, body: Delegation): Promise<[affectedCount: number]> {
	...
	async findDelegationByElectionId(election_id: number): Promise<Delegation | null> {
